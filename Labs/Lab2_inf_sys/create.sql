...
CREATE UNIQUE INDEX IF NOT EXISTS ix_prt_token_hash ON password_reset_tokens ("tokenHash");
CREATE INDEX IF NOT EXISTS ix_prt_expires_at ON password_reset_tokens ("expiresAt");
